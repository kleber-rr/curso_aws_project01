    ...
    public ResponseEntity<UrlResponse> createInvoiceUrl(){
        ...
        GeneratePresignedUrlRequest generatePresignedUrlRequest =
                new GeneratePresignedUrlRequest(bucketName, processId)
                        .withMethod(HttpMethod.PUT) //limita o acesso a esta url apenas à operação PUT
                        .withExpiration(Date.from(expirationTime)); //informando a S3 que esta url é valida apenas por 5 min
